/*! For license information please see main.6cebc383.js.LICENSE.txt */
!(function () {
  var e = {
      472: function (e) {
      ...
      463: function (e, t, n) {
        ...
        function zs(e, t, n, r, a, i) {
          ...
          if (((r = e), "function" === typeof e)) Ls(e) && (l = 1);
            ...
            e: switch (e) {
              ...
              case T:
                return (
                  ((e = Rs(19, n, t, a)).elementType = T), (e.lanes = i), e
                );
              case j:
                return Fs(n, a, i, t);
              default:
        ...
        function Hs(e, t, n, r, a, o, i, l, u) {
          return (
            ((e = Is(n, r, !0, e, 0, o, 0, l, u)).context = Vs(null)),
            (n = e.current),
  ...
  (n.n = function (e) {
    ...
    (function () {
      ...
      var A,
        M =
          ((A = "undefined" !== typeof Uint8Array && v(Uint8Array)),
          function (e) {
              ...
              return (
                ...
                o.forEach(function (e, r) {
                  !H.isUndefined(e) &&
                    null !== e &&
                    t.append(
                      !0 === l ? ee([n], r, i) : null === l ? n : n + "[]",
                      s(e)
                    );
                }),
                !1
              );
          return !!X(e) || (t.append(ee(r, n, i), s(e)), !1);
        }
        var f = [],
          d = Object.assign(te, {
            defaultVisitor: c,
      ...
      var ye = function (e) {
          function t(e, n, r, a) {
            var o = e[a++],
              ...
              l = a >= e.length;
            return (
              (o = !o && H.isArray(r) ? r.length : o),
              l
                ? (H.hasOwnProp(r, o) ? (r[o] = [r[o], n]) : (r[o] = n), !i)
        ...
        transformRequest: [
          function (e, t) {
            var n,
              ...
              o = H.isObject(e);
            if (
              (o && H.isHTMLForm(e) && (e = new FormData(e)), H.isFormData(e))
            )
      ...
      H.inherits(Te, G, { __CANCEL__: !0 });
      var Re = Te;
      var Le = ve.isStandardBrowserEnv
        ? {
      ...
      var Ue = function (e) {
        for (
          var t, n, r = (e = H.isArray(e) ? e : [e]).length, a = 0;
          a < r && ((t = e[a]), !(n = H.isString(t) ? Me[t.toLowerCase()] : t));
          a++
        );
        if (!n) {
          if (!1 === n)
      ...
      function Be(e) {
        return (
          ...
          Ue(e.adapter || we.adapter)(e).then(
            function (t) {
              return (
                Ie(e),
      ...
      function He(e, t) {
        ...
        var u = {
          ...
          headers: function (e, t) {
            return a(Ve(e), Ve(t), !0);
          },
        };
        return (
          H.forEach(Object.keys(e).concat(Object.keys(t)), function (r) {
            var o = u[r] || a,
              i = o(e[r], t[r], r);
            ...
            Q(e, [
              {
                ...
                value: function (e, t) {
                  ...
                  void 0 !== a &&
                    ...
                    (n = i && H.merge(i.common, i[t.method])) &&
                      H.forEach(
                        [
                          "delete",
                          "get",
        ...
        Je = (function () {
          function e(t) {
            ...
            this.promise.then(function (e) {
              ...
              t(function (e, t, a) {
                r.reason || ((r.reason = new Re(e, t, a)), n(r.reason));
              });
          }
          return (
            Q(
      ...
      Object.entries(Ze).forEach(function (e) {
        var t = u(e, 2),
          n = t[0],
          r = t[1];
        Ze[r] = n;
      ...
      var tt = (function e(t) {
        var n = new Ge(t),
          r = p(Ge.prototype.request, n);
        return (
          H.extend(r, Ge.prototype, n, { allOwnKeys: !0 }),
      ...
      (tt.Axios = Ge),
        ...
        (tt.mergeConfig = He),
        (tt.AxiosHeaders = Oe),
        (tt.formToJSON = function (e) {
          return ye(H.isHTMLForm(e) ? new FormData(e) : e);
        }),
        (tt.HttpStatusCode = et),
        (tt.default = tt);
      var nt = tt,
        rt = "/api/blogs",
        at = null,
        ot = function () {
          return nt.get(rt).then(function (e) {
            return e.data;
          });
        },
        it = function (e) {
          var t = { headers: { Authorization: at } };
          return nt.post(rt, e, t).then(function (e) {
            return e.data;
          });
        },
        lt = function (e, t) {
          var n = { headers: { Authorization: at } };
          return nt.put("".concat(rt, "/").concat(e), t, n).then(function (e) {
            return e.data;
          });
        },
        ut = function (e) {
          var t = { headers: { Authorization: at } };
          return nt.delete("".concat(rt, "/").concat(e), t).then(function (e) {
            return e.data;
          });
        },
        st = function (e) {
        ...
        ft = function (t) {
          var n = t.initBlog,
            ...
            l = o[0],
            s = o[1],
            c = u((0, e.useState)(n.likes), 2),
            f = c[0],
            p = c[1],
            h = u((0, e.useState)(n), 2),
            m = h[0],
            v = h[1],
            y = {
              paddingTop: 10,
                  ...
                  return a().wrap(function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            (t = d(d({}, m), {}, { likes: m.likes + 1 })),
                            (e.next = 3),
                            lt(m.id, t)
                          );
                        case 3:
                          (n = e.sent), p(n.likes), v(n);
                        case 6:
                        case "end":
                          return e.stop();
                      }
            ...
            children: l
              ? (0, ct.jsxs)("div", {
                  ...
                  children: [
                    ...
                    "likes ",
                    f,
                    (0, ct.jsx)("button", { onClick: g, children: "like" }),
                    (0, ct.jsx)("br", {}),
                    m.author,
                    (0, ct.jsx)("br", {}),
                    (0, ct.jsx)("button", { onClick: b, children: "remove" }),
                  ],
                })
              : (0, ct.jsxs)("div", {
                  style: y,
        ...
        dt = function (t) {
          ...
          return (0, ct.jsxs)("div", {
            children: [
              (0, ct.jsx)("h2", { children: "create new" }),
              (0, ct.jsxs)("form", {
                onSubmit: function (e) {
                  e.preventDefault(), n(a, f, l), o(""), s(""), d("");
                },
                children: [
                  (0, ct.jsxs)("div", {
                    children: [
                  ...
                  (0, ct.jsx)("button", { type: "submit", children: "create" }),
                ],
              }),
            ],
          });
        ...
        pt = function (e) {
          ...
          return (0, ct.jsxs)("form", {
            ...
            children: [
              ...
              (0, ct.jsx)("button", { type: "submit", children: "login" }),
            ],
          });
        };
      function ht(e, t) {
      ...
      "undefined" !== typeof document || Ot ? e.useLayoutEffect : e.useEffect,
        new WeakMap();
      var Nt = ["as", "disabled"];
      function Pt(e) {
        var t = e.tagName,
      ...
      var Tt = e.forwardRef(function (e, t) {
        var n = e.as,
          ...
          o = u(Pt(Object.assign({ tagName: n, disabled: r }, a)), 2),
          i = o[0],
          l = o[1].tagName;
        return (0, ct.jsx)(l, Object.assign({}, a, i, { ref: t }));
      });
      Tt.displayName = "Button";
      var Rt = ["onKeyDown"];
      var Lt = e.forwardRef(function (e, t) {
        var n,
          r = e.onKeyDown,
          a = (function (e, t) {
            if (null == e) return {};
          ...
          o = u(Pt(Object.assign({ tagName: "a" }, a)), 1)[0],
          i = _t(function (e) {
            o.onKeyDown(e), null == r || r(e);
          });
        return (n = a.href) && "#" !== n.trim() && "button" !== a.role
          ? (0, ct.jsx)("a", Object.assign({ ref: t }, a, { onKeyDown: r }))
          : (0, ct.jsx)("a", Object.assign({ ref: t }, a, o, { onKeyDown: i }));
      });
      Lt.displayName = "Anchor";
      var jt = Lt,
        zt = ["xxl", "xl", "lg", "md", "sm", "xs"],
        Dt = e.createContext({
          prefixes: {},
          breakpoints: zt,
          minBreakpoint: "xs",
        });
      Dt.Consumer, Dt.Provider;
      function Ft(t, n) {
        var r = (0, e.useContext)(Dt).prefixes;
        return t || r[n] || n;
      }
      function At(e, t) {
        return (
        ...
        Qt = (function (t) {
          ...
          function a(e, n) {
            ...
            return (
              ...
              e.in
                ? o
                  ? ((a = Vt), (r.appearStatus = Ht))
                  : (a = Wt)
                : (a = e.unmountOnExit || e.mountOnEnter ? Bt : Vt),
              (r.state = { status: a }),
              (r.nextCallback = null),
              r
            );
          ...
          (r = t),
            ...
            (a.getDerivedStateFromProps = function (e, t) {
              return e.in && t.status === Bt ? { status: Vt } : null;
            });
          var o = a.prototype;
          return (
            ...
            (o.updateStatus = function (e, t) {
              if ((void 0 === e && (e = !1), null !== t))
                ...
                this.props.unmountOnExit &&
                  ...
                  this.setState({ status: Bt });
            }),
            (o.performEnter = function (e) {
              var t = this,
                n = this.props.enter,
                r = this.context ? this.context.isMounting : e,
                a = this.props.nodeRef ? [r] : [Mt.findDOMNode(this), r],
                o = a[0],
                i = a[1],
                l = this.getTimeouts(),
                  ...
                  this.safeSetState({ status: $t }, function () {
                    e.props.onExiting(r),
                      e.onTransitionEnd(n.exit, function () {
                        e.safeSetState({ status: Vt }, function () {
                          e.props.onExited(r);
                        });
                      });
                  }))
      ...
      var en = function (e, t) {
          ...
          if ("string" === typeof t)
            return (
              e.style.getPropertyValue(Xt(t)) ||
              (function (e, t) {
                return Yt(e).getComputedStyle(e, t);
              })(e).getPropertyValue(Xt(t))
            );
      ...
      var mn,
        ...
        gn = ["className", "children", "transitionClasses", "onEnter"],
        bn = (c((mn = {}), Ht, "show"), c(mn, Wt, "show"), mn),
      ...
      var kn = wn,
        Sn = n(7),
        En = n.n(Sn),
        xn = ["className", "variant", "aria-label"],
        Cn = {
        ...
        _n = e.forwardRef(function (e, t) {
          var n = e.className,
            ...
            i = mt(e, xn);
          return (0,
          ct.jsx)("button", d({ ref: t, type: "button", className: yt()("btn-close", r && "btn-close-".concat(r), n), "aria-label": o }, i));
        });
      (_n.displayName = "CloseButton"), (_n.propTypes = Cn);
      var On = _n,
        Nn = /-(.)/g;
      var Pn = ["className", "bsPrefix", "as"],
        Tn = function (e) {
          return (
            e[0].toUpperCase() +
            ((t = e),
            t.replace(Nn, function (e, t) {
        ...
        var n =
          ...
          l = e.forwardRef(function (e, n) {
            var r = e.className,
              ...
              c = d(d({}, i), s),
              f = Ft(a, t);
            return (0, ct.jsx)(u, d({ ref: n, className: yt()(r, f) }, c));
          });
      ...
      var Ln,
        ...
        zn =
          ...
          e.forwardRef(function (e, t) {
            return (0,
            ct.jsx)("div", d(d({}, e), {}, { ref: t, className: yt()(e.className, Ln) }));
          }));
      zn.displayName = "DivStyledAsH4";
      var Dn = Rn("alert-heading", { Component: zn }),
        Fn = Rn("alert-link", { Component: jt }),
        An = e.forwardRef(function (e, t) {
          var n = kt(e, { show: "onClose" }),
            r = n.bsPrefix,
            a = n.show,
            o = void 0 === a || a,
            i = n.closeLabel,
      ...
      var Mn = Object.assign(An, { Link: Fn, Heading: Dn }),
        Un = function (e) {
          var t = e.success,
            n = e.error;
          return t || n
            ? (0, ct.jsx)("div", {
                className: "notif ".concat(t ? "success" : "error"),
                children: t
                  ? (0, ct.jsx)(Mn, { variant: "success", children: t })
                  : (0, ct.jsx)(Mn, { variant: "danger", children: n }),
              })
            : null;
        },
        In = (0, e.forwardRef)(function (t, n) {
            ...
            (0, ct.jsxs)("div", {
              children: [
                ...
                (0, ct.jsxs)("div", {
                  ...
                  children: [
                    t.children,
                    (0, ct.jsx)("button", { onClick: s, children: "cancel" }),
                  ],
                }),
              ],
            })
      ...
      (In.proptypes = { buttonLabel: En().string.isRequired }),
        (In.displayName = "Togglable");
      var Bn = In,
        Vn = (function () {
          var e = i(
            a().mark(function e(t) {
              ...
              return a().wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (e.next = 2), nt.post("/api/login", t);
                    case 2:
        ...
        Wn = function () {
          ...
          (0, e.useEffect)(function () {
            ...
            (0, e.useEffect)(function () {
              var e = window.localStorage.getItem("loggedBlogAppUser");
              if (e) {
                var t = JSON.parse(e);
                m(t), st(t.token);
              }
          ...
          var E = (function () {
            ...
            x = function (e, t) {
              ...
              var a = { title: e, author: h.name, url: t };
              it(a).then(function (e) {
                r(n.concat(e)),
                  k(
                    "a new blog "
                      .concat(a.title, " by ")
                      .concat(a.title, " added")
                  ),
                  setTimeout(function () {
                    k(null);
                  }, 5e3);
                        ...
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              ...
                              (e.prev = 1),
                              (e.next = 4),
                              Hn.login({ username: l, password: f })
                            );
                          case 4:
                            (n = e.sent),
            ...
            O = function () {
              ...
              return (0, ct.jsx)("div", {
                children: e.map(function (e) {
                  return (0, ct.jsx)(ft, { initBlog: e, updateBlog: E }, e.id);
                }),
              });
            };
          return (0, ct.jsx)("div", {
            ...
            children:
              null === h
                ? (0, ct.jsxs)("div", {
                    children: [
                      (0, ct.jsx)("h2", { children: "Log in to application" }),
                      (0, ct.jsx)(Un, { success: w, error: y }),
                      (0, ct.jsx)(pt, {
                        handleLogin: C,
                        setUsername: s,
                        setPassword: d,
                        ...
                        (0, ct.jsxs)("div", {
                          children: [
                            ...
                            (0, ct.jsx)(Bn, {
                              ...
                              ref: S,
                              children: (0, ct.jsx)(dt, { createBlog: x }),
                            }),
                          ],
                        }),
                      O(),
      ...
      t.createRoot(document.getElementById("root")).render((0, ct.jsx)(Wn, {}));
    })();
})();
//# sourceMappingURL=main.6cebc383.js.map
